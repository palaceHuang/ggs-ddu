...
+ 盒模型种类
  ...
  CSS3中新增 box-sizing: content-box | border-box 分别设置盒模型为标准|IE盒模型
...
## 主流浏览器
浏览器是网页显示、运行的平台。常见的浏览器有IE、火狐（Firefox）、谷歌（Chrome)、Safari和Opera等。平时称为5大浏览器。
...
目前国内一般浏览器都采用Webkit/Blink内核，如360、UC、QQ、搜狗等。
